...
export default class DafnyStatusBarElement {
  ...
  constructor(statusBar) {
    ...
    this.element = document.createElement('dafny-workbench-status');
  ...
  setStatus(status) {
    this.statusElement.classList = 'inline-block';
    this.statusElement.classList.add('dafny-status');
    switch (status) {
      case 'running':
        this.statusElement.classList.add('running', 'loading-spinner-tiny');
        break;
      case 'stopped':
